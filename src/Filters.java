...
//***************************************************************************	
	...
	static {
		...
		FIXEDFILTERS.add(new Filters("ProtanopiaFixed", new float[][] { 
			{ 0.8f, 0.1f, 0f }, { 0.8f, 0.2f, 0f }, { 0.1f, 0.6f, 0.2f } }));
		
		FIXEDFILTERS.add(new Filters("DeuteranopiaFixed", new float[][] { 
			{ 0.925f, 0.075f, 0f }, { 0.558f, 0.142f, 0.2f }, { 0f, 0.8f, 0.2f } }));
		
		FIXEDFILTERS.add(new Filters("TritanopiaFixed", new float[][] { 
			{ 0.05f, 0.95f, 0f }, { 0f, 0.133f, 0.867f }, { 0f, 0.475f, 0.525f } }));

		// Fixed Protanopaly, Deuteranopaly, Tritanomaly values
		FIXEDFILTERS.add(new Filters("ProtanomalyFixed", new float[][] { 
			{ 0.8f, 0.1f, 0f }, { 0.8f, 0.2f, 0f }, { 0.1f, 0.6f, 0.2f } }));
		
		FIXEDFILTERS.add(new Filters("DeuteranomalyFixed", new float[][] 
				{ { 0.925f, 0.075f, 0f }, { 0.558f, 0.142f, 0.2f }, { 0f, 0.8f, 0.2f } }));
		
		FIXEDFILTERS.add(new Filters("TritanomalyFixed", new float[][] { 
			{ 0.05f, 0.95f, 0f }, { 0f, 0.133f, 0.867f }, { 0f, 0.475f, 0.525f } }));
	}
